	...
	return (
		<footer id={styles.footer}>
			<div id={styles.credits}>
				<p>The Sophomore Caucus is led by Fin Ying and Andy Xian.</p>
				<p>
					This site was designed and developed by Will Zhang, Leonid
					Metlitsky, and David Chen.
				</p>
			</div>
			<a
				href={"https://github.com/leomet07/sophomore.stuysu.org"}
				target={"_blank"}
				rel="noreferrer"
